...
#define  SCL_PORT  GPIOA   // 接（SCL）
#define  SCL_PIN   GPIO_PIN_5      // 接（SCL）
#define  SDA_PORT  GPIOA   // 接（SDA）
#define  SDA_PIN   GPIO_PIN_7      // 接（SDA）
#define  RES_PORT  GPIOB   // 接 (RST/RES)
#define  RES_PIN   GPIO_PIN_0      // 接 (RST/RES)
#define  DC_PORT   GPIOB   // 接 （DC）
#define  DC_PIN    GPIO_PIN_1      // 接 （DC）
#define  CS_PORT   GPIOB  // 接 （CS）
#define  CS_PIN    GPIO_PIN_10     // 接 （CS）
//-----------------OLED端口定义----------------
//
